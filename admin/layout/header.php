...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="../../assets/themeAdmin/img/favicon/favicon.ico" />
    ...
    <link rel="stylesheet" href="../../assets/themeAdmin/vendor/css/theme-default.css"
    ...
    <link rel="stylesheet" href="../../assets/themeAdmin/vendor/libs/apex-charts/apex-charts.css" />
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item">
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="../../admin/account/index.php" class="menu-link">
                                    <div data-i18n="Account">Accounts</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="../../admin/account/create.php" class="menu-link">
                    ...
                    <!-- Cards -->
                    <li class="menu-item">
                        <a href="../../admin/product/index.php" class="menu-link">
                    ...
                    <li class="menu-item">
                        <a href="javascript:void(0)" class="menu-link menu-toggle">
                            ...
                            <div data-i18n="User interface">Product Manager</div>
                        </a>
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="../../admin/product/create.php" class="menu-link">
                    ...
                    <li class="menu-item">
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="../../admin/category/index.php" class="menu-link">
                                    <div data-i18n="Accordion">List</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="../../admin/category/create.php" class="menu-link">
                                    <div data-i18n="Accordion">Create</div>
                                </a>
                            </li>
                        </ul>
                    ...
                    <li class="menu-item">
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="../../admin/blog/index.php" class="menu-link">
                                    <div data-i18n="Accordion">List</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="../../admin/blog/create.php" class="menu-link">
                                    <div data-i18n="Accordion">Create</div>
                                </a>
                            </li>
                        </ul>
                            ...
                            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);"
                                    ...
                                    <div class="avatar avatar-online">
                                        <img src="../../assets/themeAdmin/img/avatars/1.png" alt
