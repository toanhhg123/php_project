            ...
            <tbody class="table-border-bottom-0">
                <?php foreach ($orders as $item) : ?>
                    <tr>
                        ...
                        <td><span class="badge bg-label-primary me-1"><?= $item->email ?></span></td>

                        <td><span class="badge bg-label-primary me-1"><?= $item->mobile ?></span></td>
                        <td><span class="badge bg-label-primary me-1"><?= $item->country ?></span></td>
                        <td><span class="badge bg-label-primary me-1"><?= $item->province ?></span></td>
                        <td><span class="badge bg-label-primary me-1"><?= $item->price . "$" ?></span></td>

                        <td><span class="badge bg-label-success me-1"><?= $item->qty  ?></span></td>
