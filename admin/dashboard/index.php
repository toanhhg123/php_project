...
$userLength = count(User::findAll()); 
$categoryLength = count(Category::findAll()); 
$cartLength = count(Cart::findAll());
$orderLength = count(Cart::findOrderAdmin());
$totalPrice = count(Cart::findOrderAdmin());
$totalPriceInCart =   array_reduce(Cart::findAll(), function($total, $element){
      return $total + $element->price;
}, 0);

$totalPriceOrder =   array_reduce(Cart::findOrderAdmin(), function($total, $element){
      return $total + $element->price;
}, 0);
?>
    ...
    <div class="col-lg-8 mb-4 order-0">
        <div class="card">
            <div class="d-flex align-items-end row">
                <div class="col-sm-7">
                    <div class="card-body">
                        <h5 class="card-title text-primary">Congratulations rolle! 🎉</h5>
                        <p class="mb-4">
                        ...
                        <div class="card-title d-flex align-items-start justify-content-between">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt3">
                                    <a class="dropdown-item" href="../account/index.php">View More</a>
                                </div>
                            </div>
                        </div>
                        <span class="fw-semibold d-block mb-1">Users</span>
                        <h3 class="card-title mb-2">count*: <?=$userLength ?></h3>
                        ...
                        <div class="card-title d-flex align-items-start justify-content-between">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt6">
                                    <a class="dropdown-item" href="../category/index.php">View More</a>
                                </div>
                            </div>
                        </div>
                        <span>Category</span> 
                        <h3 class="card-title text-nowrap mb-1">count:  <?=$categoryLength ?></h3>
    ...
    <div class="col-12 col-lg-8 order-2 order-md-3 order-lg-2 mb-4">
        <div class="card">
            <div class="row row-bordered g-0">
                <div class="col-md-8">
                    <h5 class="card-header m-0 me-2 pb-3">Cart</h5>
                    <div id="totalRevenueChart" class="px-2"><?=$cartLength?></div>
                </div>
                <div class="col-md-4">
                    <div class="card-body">
            ...
            <div class="col-6 mb-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h3 class="card-title text-nowrap mb-2">qty: <?=$cartLength?></h3>
            ...
            <div class="col-6 mb-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h3 class="card-title mb-2">count: <?=$orderLength?></h3>
                        ...
                        <div class="d-flex justify-content-between flex-sm-row flex-column gap-3">
                            <div class="d-flex flex-sm-column flex-row align-items-start justify-content-between">
                                <div class="card-title">
                                    <h5 class="text-nowrap mb-2">Total Price Order</h5>
                                    <span class="badge bg-label-warning rounded-pill">Year 2021</span>
                                </div>
                                <div class="mt-sm-auto">
                                    <small class="text-success text-nowrap fw-semibold"><i class="bx bx-chevron-up"></i> 68.2%</small>
                                    <h3 class="mb-0">$<?=$totalPriceOrder?></h3>
                                </div>
                            </div>
        ...
        <div class="card h-100">
            <div class="card-header d-flex align-items-center justify-content-between pb-0">
                <div class="card-title mb-0">
                    <h5 class="m-0 me-2">Cart Statistics</h5>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <div class="d-flex flex-column align-items-center gap-1">
                        <h2 class="mb-2"><?=$totalPriceInCart?></h2>
                        ...
                        <div class="d-flex p-4 pt-3">
                            ...
                            <div>
                                ...
                                <div class="d-flex align-items-center">
                                    <h6 class="mb-0 me-1">$<?=$totalPriceInCart+$totalPriceOrder?></h6>
